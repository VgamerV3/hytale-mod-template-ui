...
Built jars are written to `build/libs/hytale-mod-template-ui-1.1.0.jar`, with matching sources and javadoc jars next to it.

## Commands
- `/hduimod`: Runs UI mod actions: open, info, heartbeat, toggle, close.
- `/hduimodstatus`: Shows diagnostics for UiModPlugin.
...
2. Copy `build/libs/hytale-mod-template-ui-1.1.0.jar` into your server `mods/` directory.
